 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}ComponentType" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}DictionaryEntryName" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}Version" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}Definition" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}Cardinality" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}ObjectClassQualifier" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}ObjectClass" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}PropertyTermQualifier" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}PropertyTermPossessiveNoun" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}PropertyTermPrimaryNoun" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}PropertyTerm" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}RepresentationTerm" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}DataTypeQualifier" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}DataType" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}AssociatedObjectClassQualifier" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}AssociatedObjectClass" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}AlternativeBusinessTerms" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}Examples" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ComponentType {
    ...
    @XmlElement(name = "DictionaryEntryName")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
