 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}IndustryClassification" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}Geopolitical" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}BusinessProcess" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}OfficialConstraint" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}ProductClassification" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}BusinessProcessRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}SupportingRole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{urn:oasis:names:tc:ubl:CoreComponentParameters:1:0}SystemCapability" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
